...
class Page extends DatabaseObject {
	 ...
	 * @param bool $setTheUser if true a User::getById request will be sent and the {propertie CreatedByUser} will be set to its result
	 * @return void
	 */
	public function SetCreatedBy(int|null $createdBy, bool $setTheUser): void {
	...
	public static function NewObject(array $data): self {
		...
		$instance->CreatedAt = isset($data["created_at"]) ? new DateTime($data["created_at"]) : null;
